...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Track your daily expenses, manage your budget, monitor spending, and stay in control of your finances with our easy-to-use expense tracker." />
    <meta name="keywords" content="daily expenses, expense tracker, budget planner, money management, daily budget" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="Header">
            ...
            <div class="responsive-form">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>Is Paid :</label>
                        <select id="ddlIsPaid" class="form-control"
                            onchange="togglePaymentMode(this.value, 'ddlPaymentMode')">
            ...
            <div class="Header"
                style="margin-top: 20px; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between;">
                ...
                <div class="responsive-form" style="width: 100%; margin-top: 10px;">
                    <div class="form-row"
                        style="display: flex; align-items: end; gap: 10px; flex-wrap: nowrap;">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="fileUploadDoc" class="form-control"
                            onchange="LogoFileChange(this);" />
                        <input type="hidden" id="hfLogoUploadedFile" />
                    </div>
        ...
        <div class="modal-content" style="max-width: 800px;">
            ...
            <div class="responsive-form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>Is Paid :</label>
                        <select id="ddlEditIsPaid" class="form-control"
                            onchange="togglePaymentMode(this.value, 'ddlEditPaymentMode')">
                            <option value="No">No</option>
                            <option value="Yes">Yes</option>
                        </select>
                    </div>
    ...
    <script>
        ...
        function LogoFileChange(ctrl) {
            ImgPreview(ctrl.files, ctrl, 'hfLogoUploadedFile', 'Logo');
        }
        ...
        function GenerateReimbursementDoc() {
            ...
            showLoader();
            var hdnUserId = $('#ContentPlaceHolder1_hdnUserId').val();
            var rawLogo = $('#hfLogoUploadedFile').val();
            var finalLogoPath = rawLogo ? (rawLogo.indexOf('|') !== -1 ? '\\Uploads\\Expense\\logo\\' + rawLogo.split('|')[0] : rawLogo) : '';
        ...
        function ImgPreview(input, ctrl, hiddenFieldId = 'hfUploadedFile', callForValue = 'Expense') {
            if (!window.FormData) {
            ...
            var uploadUrl = "../AjaxResponsePages/AsyAttachement_HandlerFile.ashx?callFor=" + callForValue;
