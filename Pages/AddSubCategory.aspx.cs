    ...
    public partial class AddSubCategory : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (BusinessLogicLayer obj = new BusinessLogicLayer())
            {
                ...
                {
                    Results = obj.SubCategory_master_CRUD(Convert.ToInt32(hdnSubCatID.Value), Convert.ToInt32(ddlCategoryMaster.SelectedValue), txtSubCategoryName.Text, Convert.ToInt32(cblActive.Checked), "", "Update");
                    msg = "Update Sucessfully";
                }
                else
                {
                    Results = obj.SubCategory_master_CRUD(0, Convert.ToInt32(ddlCategoryMaster.SelectedValue), txtSubCategoryName.Text, Convert.ToInt32(cblActive.Checked), "", "Add");
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            var hdnSubCategoryName = (item.FindControl("hdnSubCategoryName") as HiddenField);
            var hdnisactive = (item.FindControl("hdnisactive") as HiddenField);
            cblActive.Checked = Convert.ToBoolean(hdnisactive.Value);

            txtSubCategoryName.Text = hdnSubCategoryName.Value;
            hdnSubCatID.Value = hdnSubCategoryId.Value;
