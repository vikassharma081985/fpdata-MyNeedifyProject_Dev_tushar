<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="WSBillingMaster.Pages.AddCategory" %>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="Header" style="padding: 5px;">
                <span>Add/Edit/View Category</span>
            ...
            <div class="content" style="text-align: left; margin-top: 10px;">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <asp:Label for="txtCategory" Text="Category Name" runat="server" />
                            <asp:TextBox runat="server" ID="txtCategory" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="Please Enter Category Name" ForeColor="Red" ControlToValidate="txtCategory" ValidationGroup="save" runat="server" />
                        ...
                        <asp:Repeater runat="server" ID="rptData">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:HiddenField runat="server" ID="hdnID" Value='<%#Eval("CategoryId") %>' />
                                        <asp:HiddenField runat="server" ID="hdnCategory" Value='<%#Eval("Category") %>' />
