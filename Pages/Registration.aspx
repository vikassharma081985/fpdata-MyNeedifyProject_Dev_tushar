        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function validateField(e) {
                    ...
                    } else if (element.id.includes("txtAadhar") && value !== "" && value.length !== 12) {
                        isValid = false;
                        if (feedback && feedback.classList.contains("invalid-feedback")) {
                            feedback.innerHTML = "Enter valid 12-digit Aadhaar.";
                            feedback.style.display = "block";
                        }
                        element.classList.add("is-invalid");
                    } else if (element.id.includes("txtPincode") && value !== "" && value.length !== 6) {
                        isValid = false;
                        if (feedback && feedback.classList.contains("invalid-feedback")) {
                            feedback.innerHTML = "Enter 6-digit Pincode.";
                            feedback.style.display = "block";
                        }
                        element.classList.add("is-invalid");
                    } else if (element.type === "checkbox" && element.hasAttribute("required") && !element.checked) {
                        isValid = false;
                        if (feedback && feedback.classList.contains("invalid-feedback")) {
                            feedback.innerHTML = "You must agree to continue.";
                            feedback.style.display = "block";
                        }
                        element.classList.add("is-invalid");
                    } else {
            ...
            <div class="card">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="editPanel" style="width: 450px;">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <button type="button" class="btn btn-lg px-4 text-white" style="background-color: #8EC243;">
                            Save
                        </button>
