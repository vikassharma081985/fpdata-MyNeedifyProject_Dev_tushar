                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <asp:TextBox ID="txtState" runat="server" CssClass="form-control"
                                            list="states-list" placeholder="Select or type state" />
                                ...
                                <div class="card card-body">
                                    <div class="row g-2 align-items-end">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <asp:TextBox ID="txtEmergencyRelation" runat="server"
                        ...
                        <div class="form-check mt-3">
                            <asp:CheckBox ID="chkConsent" runat="server" CssClass="form-check-input" />
                        ...
                        <div class="text-left mt-3">
                            ...
                            <asp:Button ID="btnSubmit" Style="background-color: #8EC243" runat="server"
                                Text="Submit Registration" CssClass="btn btn-lg px-4"
