<%@ Page Title="" Language="C#" MasterPageFile="~/Front/Home.Master" AutoEventWireup="true" CodeBehind="PlaceOrder.aspx.cs" Inherits="WSBillingMaster.Front.PlaceOrder" %>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (data.length > 0) {
                        ...
                        window.location.href = "http://localhost:46692/Front/OrderSuccess.aspx?OrderId=" + data[0].OrderId;
                    }
                    else {
