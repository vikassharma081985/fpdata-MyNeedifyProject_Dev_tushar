<%@ Page Title="" Language="C#" MasterPageFile="~/Front/Home.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="WSBillingMaster.Front.Search" %>
                ...
                success: function (result) {
                    ...
                    if (result.d.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            //html += '<a href="http://localhost:46692/Front/ItemDescription.aspx?ItemId=' + data[i].ItemId + '"  target="_blank" >';
                            html += '<div class="Tile">';
                                ...
                                <div style="height: 250px !important; width: 100%;">
                                    ...
                                    <%--<a href="<%#"http://localhost:46692/Front/ItemDescription.aspx?ItemId="+Eval("ItemId") %>" target="_blank">--%>
                                        <div class="Tile">
                                            ...
                                            <%--<img class="img-responsive img-thumbnail" alt="Img" style="height: 250px !important; width: 100%;" src="<%#"http://localhost:46692/Images/Items/"+Eval("ImageName") %>" />--%>
                                        </div>
                                    </a>
