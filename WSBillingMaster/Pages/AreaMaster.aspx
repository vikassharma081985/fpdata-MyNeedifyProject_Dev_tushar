<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AreaMaster.aspx.cs" Inherits="WSBillingMaster.Pages.AreaMaster" %>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="Header" style="padding: 5px;">
                <span>Add/Edit/View Area Master</span>
            ...
            <div class="content" style="text-align: left; margin-top: 10px;">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">                            
                            <asp:Label Fore="ddlStateMaster" Text="Select State" runat="server" />
                        ...
                        <div class="col-md-4">                             
                            <asp:Label Fore="ddlCityMaster" Text="Select City" runat="server" />
                            <asp:DropDownList runat="server" class="form-control" ID="ddlCityMaster" AutoPostBack="true" OnSelectedIndexChanged="ddlCityMaster_SelectedIndexChanged">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ErrorMessage="Select City" ForeColor="Red" ControlToValidate="ddlCityMaster" ValidationGroup="save" runat="server" />

                        </div>

                        <div class="col-md-4">                            
                             <asp:Label Fore="txtAreaName" Text="Area Name" runat="server" />
                            <asp:TextBox runat="server" ID="txtAreaName" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="Enter Area Name" ForeColor="Red" 
                                ControlToValidate="txtAreaName" ValidationGroup="save" runat="server" />
                        </div>

                        <div class="col-md-4">                            
                             <asp:Label Fore="txtPincode" Text="Pincode" runat="server" />
                            <asp:TextBox runat="server" ID="txtPincode" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="Enter pincode" ForeColor="Red" 
                                ControlToValidate="txtPincode" ValidationGroup="save" runat="server" />
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <asp:HiddenField runat="server" ID="hdnAreaID" Value="" />
