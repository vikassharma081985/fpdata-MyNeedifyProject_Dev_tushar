<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ManageSlider.aspx.cs" Inherits="WSBillingMaster.Pages.ManageSlider" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="padding: 40px; margin-top: 50px;">
        <div class="container">
            ...
            <div id="AdminList" class="content">
                <asp:GridView ID="grdAdminList" EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="grdAdminList_RowCommand" runat="server" CssClass="GridViewStyle" Width="956px" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Banner Name" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Banner">
                            <ItemTemplate>
                                <img src="<%#Eval("ImageName") %>" style="width: 50px; height:50px;" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkEdit" runat="server" CommandName="edit" OnCommand="lnkEdit_Command" CommandArgument='<%#Eval("Id") %>' Text="Edit"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Delete">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" OnCommand="lnkEdit_Command" CommandArgument='<%#Eval("Id") %>' Text="Delete"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
